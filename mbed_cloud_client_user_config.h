...
#if MBED_CLOUD_CLIENT_TRANSPORT_MODE == 0
//Default, i.e. null
#define MBED_CLOUD_CLIENT_TRANSPORT_MODE_TCP
#elif MBED_CLOUD_CLIENT_TRANSPORT_MODE == 1
#define MBED_CLOUD_CLIENT_TRANSPORT_MODE_TCP_QUEUE
#elif MBED_CLOUD_CLIENT_TRANSPORT_MODE == 2
#define MBED_CLOUD_CLIENT_TRANSPORT_MODE_UDP
#elif MBED_CLOUD_CLIENT_TRANSPORT_MODE == 3
